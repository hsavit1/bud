...
//self.title = @"Chat";//[PFUser currentUser].username;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    UIImage * imageNormal = [UIImage imageNamed:@"filled_flag-32.png"];
    ...
    outgoingBubbleImageData = [bubbleFactory outgoingMessagesBubbleImageWithColor:[UIColor colorWithRed:0.086 green:0.627 blue:0.522 alpha:1] /*#16a085*/];
